...
// Array com os caracteres do teclado brasileiro
const characters = [
    "a", "á",  "ã", 
    "b", 
    "c", "ç", 
...
// Criando botões para cada caracter do teclado brasileiro
characters.forEach(character => {
    const button = document.createElement("button");
    button.innerText = character;
    keyboardDiv.appendChild(button);
    button.addEventListener("click", (e) => initGame(e.target, character));
});
